...
public class CookBot
    ...
    private static final URI cloudRedisURI = URI.create("redis://h:p4426bdca631eb9bff2f2ce99c4799ede68fb59900642e47783781d87a5986cb2@ec2-99-80-37-150.eu-west-1.compute.amazonaws.com:17669");
    static final JedisPool pool = new JedisPool(
            new JedisPoolConfig(), CookBot.cloudRedisURI
    );
...
//    Message message = update.getMessage();
        if (update.hasMessage() && update.getMessage().hasText()) {
            ...
            final SendMessage message = new SendMessage().setChatId(
                    update.getMessage().getChatId()
            ).setText(stringBuilder.toString()).setReplyMarkup(this.getRootMenu());
            try {
